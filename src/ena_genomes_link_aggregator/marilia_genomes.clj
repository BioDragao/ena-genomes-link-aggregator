(ns ena-genomes-link-aggregator.marilia_genomes
  (:use etaoin.api)
...
;;;;;;;;;
(def marilia-genomes-edn
  (edn/read-string
    (slurp "./src/ena_genomes_link_aggregator/marilia.edn")))
...
(map extract-r-file-links-for-a-genome marilia-genomes-edn)
